...
class TestWriteGtf:
    ...
    def test_an_empty_annotation_raises_rather_than_writing_nothing(self, tmp_path):
...
class TestWriteBed:
    ...
    def test_the_source_and_phase_columns_are_not_written(self, annotation, tmp_path):
        path = tmp_path / "out.bed"
        write_bed(annotation, str(path))
